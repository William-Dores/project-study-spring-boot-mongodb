...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2021"), "Partiu Viagem", "Vou viajar para SP, abraços!", user1);
		Post post2 = new Post(null, sdf.parse("23/03/2022"), "Bom dia", "Acordei Feliz!", user1);
